...
client.login("NTY2NzM1NTUxOTI3OTQzMTgx.XLM89Q.__yLSJsd7_iCtlc2ZZA5rAxUA58");

client.on("ready", function() {
    client.user.setActivity("Ex0_DeadKingTV", {type:"WATCHING"})
})

client.on("message", message =>{
    if(message.content === "Fortnite bot settings"){
        message.reply("Va voir dans les messages épinglés ! :pushpin:");
        console.log("répond à fn stg");
    }
});
...
client.on('guildMemberAdd', member =>{
    let embed = new Discord.RichEmbed()
        .setDescription(':tada: **' + member.user.username + '** viens de rejoindre **' + member.guild.name + '**, passe un bon moment ! :smile:')
        .setFooter('Nous sommes désormais ' + member.guild.memberCount + ' sur ce serveur !')
    member.guild.channels.get('566995348246102036').send(embed)
    member.addRole('567008586681679911')
